...
--
-- Create schema heart_disease_db_be
--

CREATE DATABASE IF NOT EXISTS heart_disease_db_be;
USE heart_disease_db_be;
...
INSERT INTO `tbl_admin` (`id`,`admin_email`,`admin_password`) VALUES 
...
CREATE TABLE `tbl_doctor` (
  ...
  `doctor_mobno` varchar(45) NOT NULL,
...
INSERT INTO `tbl_doctor` (`id`,`doctor_name`,`doctor_address`,`doctor_email`,`doctor_mobno`,`doctor_password`) VALUES 
 (2,'shekhar','Pune','shekhar.thube@gmail.com','9658965896','St@1');
/*!40000 ALTER TABLE `tbl_doctor` ENABLE KEYS */;


--
-- Definition of table `tbl_tested_data`
--

DROP TABLE IF EXISTS `tbl_tested_data`;
CREATE TABLE `tbl_tested_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `patient_name` varchar(45) NOT NULL,
  `age` int(10) unsigned NOT NULL,
  `sex` int(10) unsigned NOT NULL,
  `cp` int(10) unsigned NOT NULL,
  `trestbps` int(10) unsigned NOT NULL,
  `chol` int(10) unsigned NOT NULL,
  `fbs` int(10) unsigned NOT NULL,
  `restecg` int(10) unsigned NOT NULL,
  `thalach` int(10) unsigned NOT NULL,
  `exang` int(10) unsigned NOT NULL,
  `oldpeak` int(10) unsigned NOT NULL,
  `slope` int(10) unsigned NOT NULL,
  `ca` int(10) unsigned NOT NULL,
  `thal` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `tbl_tested_data`
--

/*!40000 ALTER TABLE `tbl_tested_data` DISABLE KEYS */;
INSERT INTO `tbl_tested_data` (`id`,`patient_name`,`age`,`sex`,`cp`,`trestbps`,`chol`,`fbs`,`restecg`,`thalach`,`exang`,`oldpeak`,`slope`,`ca`,`thal`,`num`,`probability`,`result`) VALUES 
 (1,'Kiran',23,1,1,34,56,0,0,44,0,55,1,0,0,0,'NEGATIVE','NEGATIVE'),
 (2,'Sumeet',45,1,1,45,56,0,0,67,1,89,1,0,0,1,'NEGATIVE','NEGATIVE'),
 (3,'ABC',56,1,1,67,87,0,0,89,1,67,1,0,0,1,'NEGATIVE','NEGATIVE'),
 (4,'Sanket',23,1,1,45,77,1,0,66,1,33,1,0,0,1,'POSITIVE','POSITIVE');
/*!40000 ALTER TABLE `tbl_tested_data` ENABLE KEYS */;


--
-- Definition of table `tbl_train_dataset`
--

DROP TABLE IF EXISTS `tbl_train_dataset`;
CREATE TABLE `tbl_train_dataset` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `age` int(10) NOT NULL,
  `sex` int(10) NOT NULL,
  `cp` int(10) NOT NULL,
  `trestbps` int(10) NOT NULL,
  `chol` int(10) NOT NULL,
  `fbs` int(10) NOT NULL,
  `restecg` int(10) NOT NULL,
  `thalach` int(10) NOT NULL,
  `exang` int(10) NOT NULL,
  `oldpeak` float NOT NULL,
  `slope` int(10) NOT NULL,
  `ca` float NOT NULL,
  `thal` int(10) NOT NULL,
  `num` float NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=237 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_train_dataset`
--

/*!40000 ALTER TABLE `tbl_train_dataset` DISABLE KEYS */;
INSERT INTO `tbl_train_dataset` (`id`,`age`,`sex`,`cp`,`trestbps`,`chol`,`fbs`,`restecg`,`thalach`,`exang`,`oldpeak`,`slope`,`ca`,`thal`,`num`) VALUES 
...
/*!40000 ALTER TABLE `tbl_train_dataset` ENABLE KEYS */;
