					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="UserDetailsController">AllUsers</a></li>							
		...
		<div class="row">
			...
			<br><br><br><br>
	         <div class="well" style="margin-left:300px; width:400px; height:350px; margin-top:50px;">
					...
					<form action="UploadDatasetServlet" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
	 document.oncontextmenu = document.body.oncontextmenu = function() {
		 ...
		 $("#file").change(function() {
			    ...
			    switch(val.substring(val.lastIndexOf('.') + 1).toLowerCase()){
			        case 'csv':   
			        	$('#message').text("correct File").css("color" , "Green");
			        	$('#message').addClass("info");
			            
			            break;
			        default:
			            $(this).val('');
			            $('#message').text("Please select only CSV File").css("color" , "red");;
    ...
    { 
        ...
        if(imgVal=='') 
        { 
        	$('#message').text("Please select your  CSV File").css("color" , "red");;
